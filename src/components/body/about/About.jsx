...
const About = () => {
    return (
      <div>
       <label className="section-title">A little about me..</label>
       <div className="about">
       <p>
        ...
        my standards for what's expected of web applications.
        </p>
        <p>I'm excited for where my career will take me and I'm currently looking for a role where I can contribute
        my skills in coding and creativity.</p>
    </div>
   </div>
  )
}
